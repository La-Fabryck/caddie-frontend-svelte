...
<a class={buttonVariants({ variant: 'default', size: 'lg', class: 'font-semibold' })} href="/list/create">
  <Plus />
  Nouvelle liste
</a>
...
{:else}
  <ul>
    {#each allLists as list (list.id)}
      <li>
        <a href="/list/{list.id}" class="bg-surface0 hover:bg-surface1 my-2 flex justify-between gap-x-6 p-5">
